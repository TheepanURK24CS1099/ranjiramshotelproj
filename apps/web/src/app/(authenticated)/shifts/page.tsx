  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/shifts/new" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
          Add Shift
        </Link>
      </div>
          ...
          <tbody>
            {filteredShifts.map((shift) => (
              <tr key={String(shift.id)} className="border-b hover:bg-gray-50">
                ...
                <td className="p-4">
                  <span className={`px-2 py-1 text-xs rounded-full ${shift.active ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}>
